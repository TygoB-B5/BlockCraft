...
static const uint16_t SIDES_BLOCK_AIR[6] = { 0, 0, 0, 0, 0, 0 };
static const uint16_t SIDES_BLOCK_DIRT[6] = { 2, 2, 2, 2, 2, 2 };
static const uint16_t SIDES_BLOCK_GRASS[6] = { 2, 0, 3, 3, 3, 3 };
static const uint16_t SIDES_BLOCK_STONE[6] = { 1, 1, 1, 1, 1, 1 };
